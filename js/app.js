...
// ============ Bild-Lightbox ============
// Klickt man auf ein Bild (Quiz-Hinweis oder Galerie in den Land-Infos),
// öffnet sich eine vergrößerte Ansicht. Per Event-Delegation, damit auch
// dynamisch nachgeladene Bilder funktionieren.
...
document.addEventListener("click", (e) => {
  const img = e.target.closest(".clue-body img, .field-gallery img, .field-value > img");
  if (!img) return;
